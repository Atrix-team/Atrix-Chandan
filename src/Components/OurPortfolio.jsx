  ...
  return (
    <div className="bg-(--darkblack) text-(--whitelight) py-32 relative overflow-hidden">
      <div className="container mx-auto  ">
        <div className="sm:flex md:flex lg:flex xl:flex 2xl:flex justify-center  gap-10 px-10 ">
          <div className=" font-extrabold ">
            <p className="text-gray sm:text-left md:text-center lg:text-right xl:text-justify 2xl:text-justify">
              OUR PORTFOLIO
            </p>
            <h2 className="text-6xl font-bold ">Our Work</h2>
          </div>
                  ...
                  <div className="bg-(--black) pt-10 px-10   rounded-t-lg ">
                    <ul className="flex flex-wrap gap-2">
                      {item.work.map((workItem, idx) => (
                        <li
                          key={idx}
                          className="bg-(--darkblack)   rounded-full px-4 py-1 text-sm hover:bg-(--green)"
                        >
                          {workItem}
                        </li>
                      ))}
                    ...
                    <div className="relative">
                      ...
                      />
                      <button className="bg-(--black)  rounded-full px-2 py-2 text-4xl absolute -bottom-5 right-10 cursor-pointer hover:bg-(--green)">
