...
const HomeText = () => {
  ...
  return (
    <div className="relative">
      <div className="absolute top-1/2 left-1/4 transform translate-x-10 -translate-y-26 text-center z-20 moveWithMouse">
      ...
      <div className="absolute top-1/2 left-3/4 transform translate-x-60 translate-y-28 text-center z-20 moveWithMouse">
